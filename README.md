...
This is a Zotero-compatible script designed to export categorized CSV files into Neo4j. 
...
这是一个适配zotero的脚本，用于将其分类导出的CSV文件转存入Neo4j中以便我们分析论文、关键词、作者等信息的逻辑关系与统计关系，有利于快速理清论文写作方向或是提高文献管理效率。
